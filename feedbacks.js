...
module.exports = function (self) {
	...
	const feedbacksForDeviceType = (deviceType) => {
		// Definition of commonly available button feedbacks across device types
		...
		// Definitions of device specific button feedbacks
		switch (deviceType) {
			case 'BPX':
			case 'MCX':
			case 'WPX':
	...
	const feedbacks = feedbacksForDeviceType(deviceType)
